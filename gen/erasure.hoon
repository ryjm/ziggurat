...
~&  >>>  "encoding single piece..."
=/  f  (generate-field 65.536)
~&  >  (rip 3 `@`short-msg)
=/  n  2.001
=/  nsym  2.003
=/  nchunks  4.004
...
=/  encoded
  (encode-piece long-msg n f nsym nchunks generator (met 3 generator))
~&  >  (met 3 encoded)
::=/  decoded
::  (decode-piece (snap (rip 3 encoded) 2 0) f nsym ~[2] nchunks)
::~&  >>  `tape`-.decoded
~&  >>>  "finished with single piece"
::  =/  nchunks  10
::  ~&  >  "Input size: {<(div (met 3 long-msg) 1.024)>} kB"
::  =/  encoded  (encode short-msg nchunks)
::  =/  letters
::    %+  turn
::      chunks.encoded
::    |=  c=@
